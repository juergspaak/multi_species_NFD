...
remove indirect effects of multispecies communities
"""
...
for n in n_specs:
    ...
    n_coms[n] = len(A)
    # remove indirect effects, i.e. N_i^* = N_mono^*
...
fig.savefig("Figure, NFD in LV, sim, no_indirect, {}_alpha_{}.png".format(
    min_alpha, max_alpha))